...
void LoadObj::load_texture(std::string filename, const std::string suffix, TGAImage& img) {
...
vec3 LoadObj::normal(const vec2& uvf) const {
...
vec2 LoadObj::uv(const int iface, const int nthvert) const {
